...
RUNTIME_SCRIPTS_DIR = REPO_ROOT / "toolkit" / "runtime" / "scripts"
UNIT_TESTS_DIR = REPO_ROOT / "tests" / "unit"


def test_toolkit_runtime_python_scripts_have_unit_tests() -> None:
    missing = []
    for script_path in sorted(RUNTIME_SCRIPTS_DIR.glob("*.py")):
