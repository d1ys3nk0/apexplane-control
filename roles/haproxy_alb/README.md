...
The HAProxy statistics listener binds only to loopback. It serves `/_haproxy/health` and `/_stats`; expose either endpoint through `haproxy_alb_routes` as needed.
